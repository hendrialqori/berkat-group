        ...
        <main className="container font-inter flex flex-col justify-center items-center gap-10">
            ...
            <section className="flex flex-col justify-center items-center gap-6">
                ...
                <div className="text-xs font-medium w-full space-y-3">
                    <Link to={{ pathname: "/clock-in" }} className="bg-green-600 text-white w-full py-3 rounded-md flex justify-center items-center gap-2">
                        <TbClockPin className="text-lg" />
                        <span>Absen masuk</span>
                    </Link>
                    <Link to={{ pathname: "/" }} className="bg-red-600 text-white w-full py-3 rounded-md flex justify-center items-center gap-2">
